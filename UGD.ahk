...
SetBatchLines = -1
;******** Global Vars
Global Cookie,status,Config:=[],OrphanFiles:=[],ConfigTree,DebugMode:=0
DEBUG_Times:=0
...
Gui,Main:Add,Checkbox,% "xp yp+15 h20 vDebugMode gDebugMode", Enable Debug
...
{
	Gui,Submit,NoHide
	tt("Debug Mode - " DMState:=DebugMode?"On":"Off")
	;IniWrite,% DebugMode,%A_ScriptDir%\Resources\Config.ini,MainGui,DebugMode
	Return
}
